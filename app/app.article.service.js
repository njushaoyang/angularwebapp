...
var ArticleService = (function () {
    function ArticleService(http) {
        ...
        this.articleUrl = 'http://localhost:8080/flblog/article'; // URL to web api
    }
    ArticleService.prototype.getArticles = function (page, size) {
        if (page < 0 || size < 0) {
            page = 0, size = 10;
        }
        var url = this.articleUrl + "?page=" + page + "&size=" + size;
 ...
 */ 
//# sourceMappingURL=app.article.service.js.map